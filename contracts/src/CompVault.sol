...
import "../test/TestRewardController.sol";
import "../test/TestcToken.sol";

contract CompVault is Vault {

    TestRewardController public rewardController;
    TestcToken public cToken;
    ...
    function initialize(
        ...
        rewardController = TestRewardController(_rewardController);
        cToken = TestcToken(address(underlying));
    }
